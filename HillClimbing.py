...
class HillClimbing(GeneticAlgorithm.GeneticAlgorithm):
    show_each_solution = False
    show_swapping_internals =False
    silent = True
    mean_time = None
    mean_fitness = None
    climb = 0
    ...
    def __init__(self, test_case_matrix, solution_size, solutions_pool_size, number_of_rounds, is_external_swap):
